...
//    define('AWS_ACCESS_KEY_ID', '<Your Access Key ID>');
  //  define('AWS_SECRET_ACCESS_KEY', '<Your Secret Access Key>');
    define('AWS_ACCESS_KEY_ID', 'AKIAJKUARQNJ4NSCIXBA');
    define('AWS_SECRET_ACCESS_KEY', 'k3ThQOV4l2+P09nnXZlm52ekK7YVfOzIitKWV2mI');
    define('MWS_AUTHENTICATION_TOKEN','amzn.mws.44a6b6e6-77c0-328b-d62c-e5e8a0b162d7');
...
//    define('APPLICATION_VERSION', '<Your Application Version or Build Number>');
    ...
    define('APPLICATION_NAME', 'RohitApp');
    ...
    ***********************************************************************/
    ...
    define ('MERCHANT_ID', 'A3L7GADHT46N68');
